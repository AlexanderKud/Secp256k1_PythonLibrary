...
extern "C" __declspec(dllexport) void scalar_multiplication(char* priv, unsigned char* publicKeyBytesOut);
extern "C" __declspec(dllexport) void point_multiplication(unsigned char* publicKeyBytesIn, char* priv, unsigned char* publicKeyBytesOut);
...
extern "C" __declspec(dllexport) void add_point_scalar(unsigned char* publicKeyBytesIn, char* priv, unsigned char* publicKeyBytesOut);
...
extern "C" __declspec(dllexport) void subtract_point_scalar(unsigned char* publicKeyBytesIn, char* priv, unsigned char* publicKeyBytesOut);
...
extern "C" __declspec(dllexport) void privatekey_to_hash160(int type, bool compressed, char* priv, unsigned char* BytesOut);
...
extern "C" __declspec(dllexport) void privatekey_to_uwif(char* priv, unsigned char* BytesOut);
extern "C" __declspec(dllexport) void privatekey_to_cwif(char* priv, unsigned char* BytesOut);
extern "C" __declspec(dllexport) void privatekey_to_wif(bool compressed, char* priv, unsigned char* BytesOut);
extern "C" __declspec(dllexport) void wif_to_privatekey(char* wif, unsigned char* BytesOut);
extern "C" __declspec(dllexport) void privatekey_to_address(int type, bool compressed, char* priv, unsigned char* BytesOut);
