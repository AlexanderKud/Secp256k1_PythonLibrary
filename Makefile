default:
	...
	g++ -fPIC -shared -Wno-write-strings -o secp256k1_lib.so secp256k1_lib.cpp bloom.o Base58.o Bech32.o SECP256K1.o Int.o IntGroup.o IntMod.o Point.o Random.o ripemd160.o sha256.o -lgmp
	rm *.o
